...
Desktop application to send/receive capture card video feed/file data to/from Microsoft Hololens 2, a mixed reality headset. This application communicates with a Unity application (MARVIN Hololens App) which handles the UI of the headset. <b> This project is currently closed source. </b>
